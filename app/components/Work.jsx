  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 max-w-[90%] mx-auto"
      >
        {workData.map((project, index) => (
          <motion.div
            ...
            className="relative cursor-pointer rounded-lg overflow-hidden shadow-lg bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 w-full sm:w-[260px] h-[380px] mx-auto"
